...
class Products extends Model
{
    ...
    protected $fillable = ['title','code','main_id','sub_id','brand_id','description','dimensions','price','previous_price','stock','sizes','feature_image','policy','featured','views','approved','status','created_at','updated_at'];
