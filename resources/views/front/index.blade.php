        ...
        <div class="col-lg-12">
          <div class="active-banner-slider owl-carousel">
            ...
            <div class="row single-slide">
              ...
              <div class="col-lg-7">
                <div class="banner-img">
                  <img class="img-fluid" src="{{url('img/banner/banner-img.png')}}" alt="">
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="row features-inner">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
          <div class="single-features">
            <div class="f-icon">
              <img src="{{url('img/features/f-icon1.png')}}" alt="">
            </div>
            <h6>Free Delivery</h6>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
          <div class="single-features">
            <div class="f-icon">
              <img src="{{url('img/features/f-icon4.png')}}" alt="">
            </div>
          ...
          <div class="row">
            <div class="col-lg-8 col-md-8">
              <div class="single-deal">
                ...
                <img class="img-fluid w-100" src="{{url('img/category/c1.jpg')}}" alt="">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="single-product">
              <img class="img-fluid" src="{{url('img/product/p1.jpg')}}" alt="">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="single-product">
              <img class="img-fluid" src="{{url('img/product/p7.jpg')}}" alt="">
              <div class="product-details">
                <h6>addidas New Hammer sole
                  for Sports person</h6>
                <div class="price">
