<div id="sidebar-collapse" class="col-sm-4 col-lg-3 sidebar">
	<ul class="nav menu nav_active_menu">
		...
		<li><a href="{{url('admin/clients')}}"><i class="fa fa-fw fa-users">&nbsp;</i>Our Clients</a></li><li><a href="{{url('admin/whyus')}}"><i class="fa fa-fw fa-thumbs-o-up">&nbsp;</i>Why Us</a></li>
		<li><a href="{{url('admin/gallery')}}"><i class="fa fa-fw fa-file-image-o">&nbsp;</i>Inspirational Gallery</a></li>
