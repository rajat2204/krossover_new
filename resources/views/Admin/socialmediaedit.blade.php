...
<div class="col-sm-8 col-sm-offset-4 col-lg-9 col-lg-offset-3 main">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="pull-right">
                    <a href="{!! url('admin/social') !!}" class="btn btn-default btn-back"><i class="fa fa-arrow-left"></i> Back</a>
                </div>
			</div>
		</div><!--/.row-->
		...
		<div class="panel-body">
			<div class="col-md-6">
				<form role="edit-social" data-request="enable-enter" action="{{url('admin/social/'.___encrypt($social['id']))}}" method="POST" class="form-horizontal form-label-left">
					{{csrf_field()}}
					...
					<div class="form-group">
						<label>URL:</label>
						<input class="form-control" name="url" value="{{$social['url']}}" placeholder="E.g. Men's Clothing">
					</div>						
